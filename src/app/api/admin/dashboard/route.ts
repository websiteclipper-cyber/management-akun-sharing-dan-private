...
export async function GET(request: Request) {
  ...
  const [productsResult, stockResult, ticketsResult, buyersResult] = await Promise.all([
  ...
  if (productsResult.error || stockResult.error || ticketsResult.error || buyersResult.error) {
